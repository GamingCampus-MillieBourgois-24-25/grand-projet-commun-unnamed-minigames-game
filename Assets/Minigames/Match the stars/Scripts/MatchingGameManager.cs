...
public class MatchingGameManager : MonoBehaviour
{
    ...
    public Image[] playerSlots; // Slots o� le joueur place ses choix

    [Header("UI Elements")]
    public Transform centerSymbolsPanel; // Panel contenant les symboles s�lectionnables
    ...
    public float gameTime = 10f; // Temps imparti pour compl�ter le pattern
    private float timer;
    private List<Sprite> patternToMatch; // Liste du motif � reproduire
